...
Save as main.py in app2, next to: postgres.py, s3_import.py, metrics.py
...
from postgres import create_message, init_db, open_export_connection
from metrics import (
    HTTP_ERRORS,
    HTTP_REQUESTS,
...
APP_TITLE = os.getenv("APP_TITLE", "App 2 Chat")
